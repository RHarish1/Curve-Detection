...
const uploadAndAnalyzeImage = async (canvas) => {
...
saveImgBtn.addEventListener("click", async () => {
    const canvas = saveImage(); // Save the image and get the canvas
    await uploadAndAnalyzeImage(canvas); // Send the canvas image to the server
});
